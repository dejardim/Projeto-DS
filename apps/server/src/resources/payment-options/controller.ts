...
export const validatePaymentOptionParams = [
  param('paymentOptionUid').notEmpty().withMessage('Payment Option ID is required'),
];
...
export class PaymentOptionsController {
  async create(req: Request, res: Response) {
    try {
      ...
      const result = await paymentOptionsService.create(spreadsheetUid, req.body);
  ...
  async getById(req: Request, res: Response) {
    try {
      ...
      const result = await paymentOptionsService.getById(spreadsheetUid, paymentOptionUid);
  ...
  async update(req: Request, res: Response) {
    try {
      ...
      const result = await paymentOptionsService.update(spreadsheetUid, paymentOptionUid, req.body);
  ...
  async delete(req: Request, res: Response) {
    try {
      ...
      const result = await paymentOptionsService.delete(spreadsheetUid, paymentOptionUid);
