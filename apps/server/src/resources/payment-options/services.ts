...
export interface UpdatePaymentOptionData
    extends Partial<CreatePaymentOptionData> {}
...
export class PaymentOptionsService {
    ...
    async update(
        ...
        paymentOptionUid: string,
        data: UpdatePaymentOptionData,
    ) {
