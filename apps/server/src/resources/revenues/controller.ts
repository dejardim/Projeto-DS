...
export class RevenuesController {
  async create(req: Request, res: Response) {
    try {
      ...
      const result = await revenuesService.create(spreadsheetUid, req.body);
  ...
  async getById(req: Request, res: Response) {
    try {
      ...
      const result = await revenuesService.getById(spreadsheetUid, revenueUid);
  ...
  async update(req: Request, res: Response) {
    try {
      ...
      const result = await revenuesService.update(spreadsheetUid, revenueUid, req.body);
  ...
  async delete(req: Request, res: Response) {
    try {
      ...
      const result = await revenuesService.delete(spreadsheetUid, revenueUid);
